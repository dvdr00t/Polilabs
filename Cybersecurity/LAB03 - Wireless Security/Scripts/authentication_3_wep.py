...
def topology():
    ...
    info("*** Creating nodes\n")
    sta1 = net.addStation('sta1', passwd='abcdeabcde', encrypt='wep')
    sta2 = net.addStation('sta2', passwd='abcdeabcde', encrypt='wep')
    sta3 = net.addStation('sta3', passwd='abcdeabcde', encrypt='wep')
    ap1 = net.addAccessPoint('ap1', ssid="simplewifi", mode="g", channel="1",
                             passwd='abcdeabcde', encrypt='wep',
...
#    in this case the stations are not associated because useful allow users to start the WEP associations
