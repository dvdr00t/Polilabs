...
export declare class HttpError extends Error implements ValidationError {
    ...
    static create(err: {
        ...
        message?: string;
        errors?: ValidationErrorItem[];
    }): InternalServerError | UnsupportedMediaType | RequestEntityToLarge | BadRequest | MethodNotAllowed | NotFound | Unauthorized | Forbidden;
}
...
export declare class RequestEntityToLarge extends HttpError {
    constructor(err: {
        path: string;
        message?: string;
        overrideStatus?: number;
